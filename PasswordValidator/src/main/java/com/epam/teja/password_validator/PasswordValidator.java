...
public class PasswordValidator {
    ...
    public boolean validatePassword(final String password) {
        return validateLength(password)
               ...
               && validateAtLeastOneUpperCase(password)
               && validateAtLeastOneLowerCase(password)
               && validateAtLeastOneSpecialCase(password)
               && !validateIsStartingWithNumber(password)
               && !validateIsStartingWithSpecialChar(password)
               && !validateIsContainingInvalidSpecialChar(password);
    }
